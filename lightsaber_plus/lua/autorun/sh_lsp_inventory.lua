...
function saberEquip(ply, item, hash)
	...
	if IsValid(wep) then
		...
		for i=1,10 do
			...
			if !(blade == "") then
				local currentItem = itemGetData(hash, "blade"..i, "")
				if !(currentItem == "") then
					local crystalItem = getItem(currentItem)
					if crystalItem then
						local vec = Vector(crystalItem.color.r, crystalItem.color.g, crystalItem.color.b)
						wep:syncLightsaberPlusData("blade"..i, vec)
						wep:syncLightsaberPlusData("bladeItem"..i, currentItem)
					end
				end
			end
		end
...
function saberOffHand(ply, item, hash)
	local wep = ply:GetActiveWeapon()
	if IsValid(wep) then
		if wep.hash != hash then
			wep.offhash = hash
			wep:syncLightsaberPlusData("OFFHAND-itemClass", item.id)
			wep:syncLightsaberPlusData("OFFHAND-crystalDamage", 1)
			for i=1,10 do
				local quil = itemGetData(hash, "quillon"..i, "")
				if !(quil == "") then
					local currentItem = itemGetData(hash, "quillon"..i, "")
...
local gunFuncs = {
	["Equip"] = {
		canRun = function(ply, item, hash)
			return true
		end,
		onRun = function(ply, item, hash)
			local wep = ply:Give(item.class)
			if IsValid(wep) then
				wep:SetClip2(0)
				wep:SetClip1(0)
				ply:RemoveAmmo(9999, wep.Primary.Ammo)
				ply:RemoveAmmo(9999, wep.Primary.Ammo)
			end
		end,
	},
...
local gunDrop = function(ply, item, hash)
	ply:StripWeapon(item.class)
	return true
end
...
function createCrystal(name, wm, dmg, onHit, mtl)
	for crystal,color in pairs(crystalModels) do
		...
		addItem("kyber_crystal_" .. string.lower(name).."_"..mdl, {
...
-- // Custom Crystal Example
/*
addItem("kyber_crystal_super_cool", {
	name = " SUPER COOL Crystal",
	mdl = "models/red5/red5.mdl",
	desc = "yeet",
	color = Color(255,0,0),
	bladeMaterial = "saberplussabers/blades/xozz.png",
...
local lastR = 0
hook.Add("Think", "j902o4t", function()
	if lastR <= CurTime() then
		hook.Run("lightsaberPlusAddItems")
		lastR = CurTime() + 60
	end
end)
...
addItem("lightsaber_revanite_eu", {
...
addItem("lightsaber_tonfaforward", {
...
addItem("lightsaber_maulunique_one", {
...
addItem("lightsaber_maulunique_two", {
...
addItem("lightsaber_equilibrium", {
...
addItem("lightsaber_tridentdual", {
...
addItem("lightsaber_legendarypike", {
...
addItem("lightsaber_knowledgeseeker", {
...
addItem("lightsaber_prototypegauntlet", {
...
addItem("lightsaber_darkforce_2", {
...
addItem("lightsaber_darkknight_2", {
...
addItem("lightsaber_darksaber_ancient", {
...
addItem("lightsaber_felucia_two", {
...
addItem("lightsaber_lighsideaffiliation", {
...
addItem("lightsaber_pulsating_2", {
...
addItem("lightsaber_adascorppole", {
...
addItem("lightsaber_antiquesocorrolightsaber", {
...
addItem("lightsaber_antiquesocorrolightsaber_cresh", {
...
addItem("lightsaber_antiquesocorrolightsaber_dorn", {
...
addItem("lightsaber_antiquesocorrolightsaberstaff", {
...
addItem("lightsaber_antiquesocorrolightsaberstaff_dorn", {
...
addItem("lightsaber_arakydsaber", {
...
addItem("lightsaber_ardentdefender", {
...
addItem("lightsaber_ardentdefender_lightsaber", {
...
addItem("lightsaber_artusianlightsaber", {
...
addItem("lightsaber_artusiansaberstaff", {
...
addItem("lightsaber_asharaslightsaber", {
...
addItem("lightsaber_attunedforcelord", {
...
addItem("lightsaber_blademastersattenuated", {
...
addItem("lightsaber_blademastersattenuated_staff", {
...
addItem("lightsaber_blademastersattenuated_shoto", {
...
addItem("lightsaber_blademastersattenuated_ancient", {
...
addItem("lightsaber_blademastersattenuatedstaff_ancient", {
...
addItem("lightsaber_blademastersattenuatedshoto_ancient", {
...
addItem("lightsaber_chrysopazsaberstaff", {
...
addItem("lightsaber_conquerorsaberstaff", {
...
addItem("lightsaber_coruscalightsaber", {
...
addItem("lightsaber_coruscalightsaberstaff", {
...
addItem("lightsaber_custom-builtdoublebladedsaber", {
...
addItem("lightsaber_darkreveriedoublebladedsaber", {
...
addItem("lightsaber_darkseekersdoublebladedsaber", {
...
addItem("lightsaber_dauntlessavengerslightsaber", {
...
addItem("lightsaber_defenderlightsaber", {
...
addItem("lightsaber_defianttechnographerdualsaber", {
...
addItem("lightsaber_defianttechnographerlgihtsaber", {
...
addItem("lightsaber_defianttechnographerlgihtsabershoto", {
...
addItem("lightsaber_derelictlightsaber", {
...
addItem("lightsaber_derelictsaberstaff", {
...
addItem("lightsaber_descendantsheirloomdualsaber", {
...
addItem("lightsaber_desolatorsstarforgeddualsaber", {
...
addItem("lightsaber_despotsdualsaber", {
...
addItem("lightsaber_devastatorsdoublebladedlightsaber", {
...
addItem("lightsaber_diabolistlightsaber", {
...
addItem("lightsaber_dragonpearllightsaber", {
...
addItem("lightsaber_dragonpearlsaberstaff", {
...
addItem("lightsaber_elegantmodifieddoublebladedsaber", {
...
addItem("lightsaber_etchedduelerdualsaber", {
...
addItem("lightsaber_eternalcommandermk-14saberstaff", {
...
addItem("lightsaber_eternalcommandermk-14lightsaber", {
...
addItem("lightsaber_exarch'smk-1lightsaber", {
...
addItem("lightsaber_exarch'smk-2lightsaber", {
...
addItem("lightsaber_executioner'slightsaber", {
...
addItem("lightsaber_exquisitechampiondualsaber", {
...
addItem("lightsaber_fearlessretaliator'slightsaber", {
...
addItem("lightsaber_fearlessretaliator'ssaberstaff", {
...
addItem("lightsaber_firenodelightsaber", {
...
addItem("lightsaber_frontierhunter'sdualsaber", {
...
addItem("lightsaber_frontierhunter'slightsaber", {
...
addItem("lightsaber_geminimk-4lightsaber", {
...
addItem("lightsaber_grantekf11-ddualsaber", {
...
addItem("lightsaber_grantekf11-dsaber", {
...
addItem("lightsaber_herald'spolesaber", {
...
addItem("lightsaber_hermit'spolesaber", {
...
addItem("lightsaber_hiridulightsaber", {
...
addItem("lightsaber_hiridusaberstaff", {
...
addItem("lightsaber_ice-jewellightsaber", {
...
addItem("lightsaber_indomitablevanquisher'ssaberstaff", {
...
addItem("lightsaber_inscrutabledualsaber", {
...
addItem("lightsaber_instigator'slightsaber", {
...
addItem("lightsaber_iokathmk-4saberstaff", {
...
addItem("lightsaber_mytaglightsaber", {
...
addItem("lightsaber_novalightsaber", {
...
addItem("lightsaber_occultists'polesabermk1", {
...
addItem("lightsaber_outlanderlightsaber", {
...
addItem("lightsaber_outlanderlightsaber2", {
...
addItem("lightsaber_outlanderpolesaber", {
...
addItem("lightsaber_outlanderpolesaber2", {
...
addItem("lightsaber_overseer'slightsaber", {
...
addItem("lightsaber_pitilessraiderlightsaber", {
...
addItem("lightsaber_praetorian'slightsaber", {
...
addItem("lightsaber_prophet'sstarforgeddualsaber", {
...
addItem("lightsaber_reckoning'sexposedlightsaber", {
...
addItem("lightsaber_reckoning'sexposedsaberstaff", {
...
addItem("lightsaber_redeemer'sstarforgeddualsaber", {
...
addItem("lightsaber_retribution'sexposedlightsaber", {
...
addItem("lightsaber_revanite'smk-1lightsaber", {
...
addItem("lightsaber_revanite'smk-1polesaber", {
...
addItem("lightsaber_revanite'smk-2saber", {
...
addItem("lightsaber_revanite'smk-2polesaber", {
...
addItem("lightsaber_righteousprimevallightsaber", {
...
addItem("lightsaber_rishi'slightsabermk-1", {
...
addItem("lightsaber_rishi'smk-1polesaber", {
...
addItem("lightsaber_sateleshan'sdualsaber", {
...
addItem("lightsaber_sateleshan'ssparringlightsaber", {
...
addItem("lightsaber_senyatirall'slightsaber-cartel", {
...
addItem("lightsaber_senyatirall'slightsaber-companion", {
...
addItem("lightsaber_serenity'sunsealedsaberstaff", {
...
addItem("lightsaber_strongholddefender'slightsaber", {
...
addItem("lightsaber_strongholddefender'ssaberstaff", {
...
addItem("lightsaber_temptedapprentice'sdualsaber", {
...
addItem("lightsaber_temptedapprentice'ssaber", {
...
addItem("lightsaber_thermallightsabermk-3", {
...
addItem("lightsaber_thexan'slightsaber", {
...
addItem("lightsaber_tythianlightsaber", {
...
addItem("lightsaber_tythianforce-masterlightsaber", {
...
addItem("lightsaber_unrelentingaggressordualsaber", {
...
addItem("lightsaber_unstablearbiter'sdualsaber", {
...
addItem("lightsaber_unstablearbiter'slightsaber", {
...
addItem("lightsaber_unstablepeacemaker'sdualsaber", {
...
addItem("lightsaber_unstablepeacemaker'slightsaber", {
...
addItem("lightsaber_vengeance'sunsealedlightsaber", {
...
addItem("lightsaber_vengeance'sunsealedsaberstaff", {
...
addItem("lightsaber_vigorousbattlerdualsaber", {
...
addItem("lightsaber_vindicator'slightsaber", {
...
addItem("lightsaber_vindicator'ssaberstaff", {
...
addItem("lightsaber_warden'slightsaber", {
...
addItem("lightsaber_warmaster'sdoublebladedlightsaber", {
...
addItem("lightsaber_zakuulan'smk-1polesaber", {
...
addItem("lightsaber_zakuulan'smk-2polesaber", {
...
addItem("lightsaber_ziostguardian'slightsaber", {
